...
/**
 * Load guest_agents block from proxmox package config.
 *
 * @param {string} proxmoxPackageRoot absolute path to packages/infrastructure/proxmox
 */
export function loadGuestAgentsConfig(proxmoxPackageRoot) {
  const loaded = tryLoadPackageConfigFromPackageRoot(proxmoxPackageRoot, {
...
/**
 * Resolve proxmox package root from repo layout.
 *
