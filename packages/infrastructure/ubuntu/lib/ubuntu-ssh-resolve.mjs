...
import { listSshTargetsFromSidecar } from "../../../../tools/hdc/lib/users-bootstrap-hdc.mjs";
 ...
 */
export function resolveUbuntuBootstrapSsh(packageRoot, hostId, env) {
  const path = join(packageRoot, "config.json");
