...
```bash
node tools/hdc/cli.mjs run infrastructure ubuntu maintain --
node tools/hdc/cli.mjs run infrastructure ubuntu deploy -- create-container
node tools/hdc/cli.mjs users bootstrap-hdc --
node tools/hdc/cli.mjs help run infrastructure ubuntu
```

CLI id is **`ubuntu`** (infrastructure). Home workstations use **`client-ubuntu`** under `packages/clients/ubuntu/`.
...
- [AGENTS.md](../../../AGENTS.md)
- Home clients: [`packages/clients/ubuntu/README.md`](../../clients/ubuntu/README.md) (`client-ubuntu`)
