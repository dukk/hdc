...
node tools/hdc/cli.mjs run service wazuh deploy -- --instance a --destroy-existing
...
```json
{
  ...
  "proxmox": {
    "host_id": "pve-b",
    "qemu": { "vmid": 562, "ip": "10.0.0.202/24", "template_vmid": 9022 }
  },
  "configure": { "ssh": { "host": "10.0.0.202" } }
}
```
