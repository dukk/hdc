...
- hdc-private `packages/services/openclaw/config.json` with static IP, vmid, and `proxmox.host_id`
...
```bash
node tools/hdc/cli.mjs run service openclaw query --
node tools/hdc/cli.mjs run service openclaw deploy -- --instance a
node tools/hdc/cli.mjs run service openclaw maintain --
node tools/hdc/cli.mjs run service openclaw query -- --live
node tools/hdc/cli.mjs run service openclaw teardown -- --instance a --yes
```
