...
import { installPaperclipInCt, readCtPrimaryIp, resolvePveSshForHost } from "../lib/paperclip-install.mjs";
import { hostPort, resolveUpstreamUrl, resolveWebUrl } from "../lib/paperclip-render.mjs";
import {
...
const PACKAGE_CONFIG_EXAMPLE = "packages/services/paperclip/config.example.json";
