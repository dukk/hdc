...
```bash
node tools/hdc/cli.mjs secrets set HDC_MOSQUITTO_PASSWORD_HOMEASSISTANT
node tools/hdc/cli.mjs run service mosquitto deploy -- --instance a
node tools/hdc/cli.mjs run service mosquitto query -- --live
node tools/hdc/cli.mjs run service mosquitto maintain -- --renew-certs
```
...
- Schema: [`tools/hdc/schema/mosquitto.config.schema.json`](../../../tools/hdc/schema/mosquitto.config.schema.json)
- step-ca: [`packages/services/step-ca/README.md`](../step-ca/README.md)
