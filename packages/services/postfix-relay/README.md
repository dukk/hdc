...
```bash
node tools/hdc/cli.mjs run service postfix-relay deploy --
node tools/hdc/cli.mjs run service postfix-relay maintain --
node tools/hdc/cli.mjs run service postfix-relay maintain -- --apply-network
```
