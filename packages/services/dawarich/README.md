...
```bash
node tools/hdc/cli.mjs run service dawarich deploy -- --instance a
node tools/hdc/cli.mjs run service dawarich query -- --live
node tools/hdc/cli.mjs run service dawarich maintain --
```
...
- Schema: [`tools/hdc/schema/dawarich.config.schema.json`](../../../tools/hdc/schema/dawarich.config.schema.json)
