...
```bash
node tools/hdc/cli.mjs run service nextcloud deploy -- --instance a
node tools/hdc/cli.mjs run service nextcloud query -- --live
node tools/hdc/cli.mjs run service nextcloud maintain --
```
