...
import { hostPort, resolveSearxngDeployments } from "../lib/deployments.mjs";
import { findClusterGuest } from "../lib/guest-exists.mjs";
import { installSearxngInCt, readCtPrimaryIp, resolvePveSshForHost } from "../lib/searxng-install.mjs";
import {
...
import { createSearxngVaultAccess } from "../lib/vault-deps.mjs";
import { resolveSearxngSecret } from "../lib/vault-secrets.mjs";
...
const PACKAGE_CONFIG_EXAMPLE = "packages/services/searxng/config.example.json";
