...
import { resolveKeycloakDeployments } from "../lib/deployments.mjs";
import { findClusterGuest } from "../lib/guest-exists.mjs";
import { composeDownInCt, resolvePveSshForHost } from "../lib/keycloak-install.mjs";
...
const PACKAGE_CONFIG_EXAMPLE = "packages/services/keycloak/config.example.json";
