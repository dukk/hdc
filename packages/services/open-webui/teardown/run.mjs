...
import { resolveOpenWebuiDeployments } from "../lib/deployments.mjs";
import { findClusterGuest } from "../lib/guest-exists.mjs";
import { composeDownInCt, resolvePveSshForHost } from "../lib/open-webui-install.mjs";
import {
  confirmTeardown,
  teardownDryRun,
...
const PACKAGE_CONFIG_EXAMPLE = "packages/services/open-webui/config.example.json";
