...
- **OpenRouter account:** optional credits/key lifecycle via [`packages/infrastructure/openrouter`](../../infrastructure/openrouter/README.md)
...
node tools/hdc/cli.mjs run service hermes deploy -- --instance a --destroy-existing
