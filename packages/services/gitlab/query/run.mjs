...
import { resolvePveSshForHost } from "../lib/gitlab-install.mjs";
import { queryGitlabInCt } from "../lib/query-status.mjs";
import { loadPackageConfigFromPackageRoot, tryLoadPackageConfigFromPackageRoot } from "../../../lib/package-run-config.mjs";

const here = dirname(fileURLToPath(import.meta.url));
const packageRoot = join(here, "..");
const PACKAGE_CONFIG_EXAMPLE = "packages/services/gitlab/config.example.json";
...
function loadCfg() {
  ...
  try {
    const example = loadPackageConfigFromPackageRoot(packageRoot, { filename: "config.example.json" });
