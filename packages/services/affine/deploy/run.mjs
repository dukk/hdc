...
import { resolveAffineDeployments } from "../lib/deployments.mjs";
import { findClusterGuest } from "../lib/guest-exists.mjs";
import { installAffineInCt, readCtPrimaryIp, resolvePveSshForHost } from "../lib/affine-install.mjs";
import { hostPort, resolveUpstreamUrl, resolveWebUrl } from "../lib/affine-render.mjs";
import {
...
import { createAffineVaultAccess } from "../lib/affine-vault-deps.mjs";
import { resolveAffineSecrets } from "../lib/vault-secrets.mjs";
...
const PACKAGE_CONFIG_EXAMPLE = "packages/services/affine/config.example.json";
