...
```bash
node tools/hdc/cli.mjs run service affine deploy -- --instance a
node tools/hdc/cli.mjs run service affine query -- --live
node tools/hdc/cli.mjs run service affine maintain --
node tools/hdc/cli.mjs run service affine teardown -- --instance a --yes
```
...
- Schema: [`tools/hdc/schema/affine.config.schema.json`](../../../tools/hdc/schema/affine.config.schema.json)
