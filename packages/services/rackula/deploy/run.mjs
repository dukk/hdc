...
import { resolveRackulaDeployments } from "../lib/deployments.mjs";
import { findClusterGuest } from "../lib/guest-exists.mjs";
import { installRackulaInCt, readCtPrimaryIp, resolvePveSshForHost } from "../lib/rackula-install.mjs";
import { apiWriteTokenEnabled, hostPort, resolveUpstreamUrl, resolveWebUrl } from "../lib/rackula-render.mjs";
import { createRackulaVaultAccess, resolveApiWriteToken } from "../lib/vault-deps.mjs";
import {
...
const PACKAGE_CONFIG_EXAMPLE = "packages/services/rackula/config.example.json";
 ...
 * @param {{ ctPasswordCache?: { value: string | null }; vaultAccess?: import("../../../../tools/hdc/lib/vault-access.mjs").VaultAccess | null }} runOpts
 */
...
async function main() {
  ...
  /** @type {import("../../../../tools/hdc/lib/vault-access.mjs").VaultAccess | null} */
