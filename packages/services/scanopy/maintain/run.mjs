...
import { resolveScanopyDeployments } from "../lib/deployments.mjs";
import { maintainScanopyInCt, resolvePveSshForHost } from "../lib/scanopy-install.mjs";
...
const PACKAGE_CONFIG_EXAMPLE = "packages/services/scanopy/config.example.json";
