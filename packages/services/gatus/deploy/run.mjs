...
import { resolveGatusDeployments } from "../lib/deployments.mjs";
import { findClusterGuest } from "../lib/guest-exists.mjs";
import { installGatusInCt, readCtPrimaryIp, resolvePveSshForHost } from "../lib/gatus-install.mjs";
import { configureGatusInCt } from "../lib/gatus-configure.mjs";
import { gatusListenPort } from "../lib/gatus-render.mjs";
...
const PACKAGE_CONFIG_EXAMPLE = "packages/services/gatus/config.example.json";
