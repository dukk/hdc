...
```bash
node tools/hdc/cli.mjs run service docuseal deploy -- --instance a
node tools/hdc/cli.mjs run service docuseal query -- --live
node tools/hdc/cli.mjs run service docuseal maintain --
```
...
- Schema: [`tools/hdc/schema/docuseal.config.schema.json`](../../../tools/hdc/schema/docuseal.config.schema.json)
