...
} from "../../../packages/infrastructure/proxmox/lib/proxmox-qemu-guest-agent.mjs";

/** @type {import("../../../packages/infrastructure/proxmox/lib/proxmox-host-load-report.mjs").GuestConfig} */
const baseGuest = {
  vmid: 107,
  name: "portainer-a",
  type: "qemu",
