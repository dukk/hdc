...
vi.mock("../../../packages/infrastructure/proxmox/lib/pve-http.mjs", () => ({
...
import { ensureLxcStarted, getLxcRuntimeStatus } from "../../../packages/infrastructure/proxmox/lib/proxmox-lxc-start.mjs";
