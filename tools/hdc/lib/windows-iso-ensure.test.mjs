...
import { resolveDiskFormat, scsi0VolumeSpec } from "../../../packages/services/windows-desktop/lib/disk-format.mjs";
import {
  normalizeSha256,
  windowsIsoRemotePath,
} from "../../../packages/services/windows-desktop/lib/windows-iso-ensure.mjs";
