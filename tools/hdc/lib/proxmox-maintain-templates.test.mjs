...
import { parseStorageVolid } from "../../../packages/infrastructure/proxmox/lib/proxmox-config.mjs";
import {
  applianceTemplateFromVolid,
  provisionRequirementsFromConfig,
  pveAuthFailureHint,
} from "../../../packages/infrastructure/proxmox/lib/proxmox-maintain-templates.mjs";
