...
import { liveMonitorsToConfigEntries } from "../../../packages/services/uptime-kuma/lib/uptime-kuma-import.mjs";
import {
...
/** @type {import("../../../packages/services/uptime-kuma/lib/uptime-kuma-config.mjs").LiveMonitor} */
