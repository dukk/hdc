...
Maps task titles to hdc-runner schedule runs. See `clumps/services/paperclip/lib/paperclip-agent-bridge.mjs`.

## Examples

```bash
export RUNNER=http://192.0.2.125:9120
export TOKEN=$(node apps/hdc-cli/cli.mjs secrets get HDC_HDC_RUNNER_API_TOKEN)
