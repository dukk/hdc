 ...
 * @param {{ ctPasswordCache?: { value: string | null }; vaultAccess?: import("../../../../apps/hdc-cli/lib/vault-access.mjs").VaultAccess | null }} runOpts
 */
...
async function main() {
  ...
  /** @type {import("../../../../apps/hdc-cli/lib/vault-access.mjs").VaultAccess | null} */
