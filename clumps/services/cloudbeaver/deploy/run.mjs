...
import { resolveCloudbeaverDeployments } from "../lib/deployments.mjs";
import { findClusterGuest } from "../lib/guest-exists.mjs";
import {
  installCloudbeaverInCt,
  readCtPrimaryIp,
  resolvePveSshForHost,
} from "../lib/cloudbeaver-install.mjs";
import { hostPort, resolveUpstreamUrl, resolveWebUrl } from "../lib/cloudbeaver-render.mjs";
import { resolveCloudbeaverSecrets } from "../lib/vault-secrets.mjs";
import {
...
import { createCloudbeaverVaultAccess } from "../lib/vault-deps.mjs";
 ...
 * @param {{ ctPasswordCache?: { value: string | null }; vault: import("../../../../apps/hdc-cli/lib/vault-access.mjs").VaultAccess }} runOpts
 */
