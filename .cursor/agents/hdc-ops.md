...
You help operate the HDC repo using the **hdc** CLI and the files under `inventory/manual/`, `inventory/automated/`, `docs/manually-deployed/`, and `packages/`.
...
- Prefer editing `inventory/manual/{systems,networks,services,targets}/*.json` for structured data; keep narrative in `.md` outside generated marker blocks.
