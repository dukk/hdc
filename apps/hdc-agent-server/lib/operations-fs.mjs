...
/** @typedef {"hdc-manager"|"hdc-sre-ops"|"hdc-sre-engineer"|"hdc-monitor"|"hdc-security-expert"|"hdc-security-architect"|"hdc-network-architect"|"hdc-research"|"hdc-qa"} TaskRole */
