...
import { authorizeProxmoxForHost } from "hdc/clump/infrastructure/proxmox/lib/proxmox-deploy-auth.mjs";
import {
  fetchClusterVmResources,
  locateVmidInCluster,
} from "hdc/clump/infrastructure/proxmox/lib/proxmox-host-provisioner.mjs";
import { locateGuestByNameInCluster } from "hdc/clump/infrastructure/proxmox/lib/proxmox-backup-maintain.mjs";
import { ensureGuestPackageTag, proxmoxGuestTypeFromMode } from "hdc/clump/infrastructure/proxmox/lib/proxmox-guest-tags.mjs";
